 ...
 * checkers_win {}; trade_properties {count}; dockside_run {crates}; block_drop_sweep {} after four rows; golf_hole {strokes,par} on an
...
(function () {
  ...
  const GAME_IDS = ['snake', 'dodger', 'memory', 'reaction', 'word', 'flappy', 'platform', 'tic', 'checkers', 'trade', 'golf', 'driftlock', '2048', 'dockside', 'invaders', 'hex-stack', 'minesweeper', 'block-drop'];
  ...
  const definitions = [
    ...
    ['block-drop-sweep', 'Clean sweep', 'Clear four rows at once in Block Drop.', '▤', 'blockDropSweeps', 1],
