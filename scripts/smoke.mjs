...
for (const marker of ["phasebound", "copy", "play-intelligence", "overlay-feedback", "score-save", "your initials or name", "preview: true", "leaderboard", "phasebound-card-preview-root", "Grab cyan"]) {
