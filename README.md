...
The gallery keeps a small local Phasebound leaderboard in this browser only. It stores starts, completed runs, time played, wins, packets, experiment variants, optional run feedback, a score name, and scores you submit. No analytics vendor, account, cookie, network call, or public score service is involved.
