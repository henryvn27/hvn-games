...
for (const marker of ["phasebound", "ORBIT_ROUTE", "?game=${ORBIT_ROUTE}", "copy", "play-intelligence", "overlay-detail", "score-save", "first-play-tutorial", "tutorial-start", "tutorial-dot-life", "hud-phase", "hud-lives", "leaderboard", "Grab cyan"]) {
