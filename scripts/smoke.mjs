...
for (const marker of ["phasebound", "copy", "play-intelligence", "overlay-feedback", "score-save", "Three letters or a name", "preview: true", "leaderboard", "phasebound-card-preview-root", "Grab the cyan dots"]) {
