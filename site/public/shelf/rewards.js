...
(function () {
  ...
  const definitions = [
    ...
    ['memory-master', 'Perfectly inventoried', 'Finish Field Kit in 16 moves or fewer.', '🧰', 'memoryMoves', 16, 'atMost', 'moves'],
    ...
    ['platform-win', 'Route runner', 'Reach the flag in Rooftop Run.', '🚩', 'platformWins', 1],
