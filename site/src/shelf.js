...
export const SHELF_GAMES = [
  { id: "golf", number: "01", name: "Mini Golf", kind: "arcade", playStyle: "timing", playCue: "Aim around the banks", description: "Six small greens. Banks, bunkers, and a clean line to the cup." },
  { id: "snake", number: "02", name: "Snake", kind: "arcade", playStyle: "action", playCue: "Steer for the apples", description: "Eat apples, grow longer, and don’t hit the wall." },
  { id: "dodger", number: "03", name: "Space Dodger", kind: "arcade", playStyle: "action", playCue: "Fly through incoming traffic", description: "Keep the fighter moving while Mars gets busier around you." },
  { id: "memory", number: "04", name: "Memory Match", kind: "arcade", playStyle: "puzzle", playCue: "Remember each flip", description: "Find every matching pair in as few moves as possible." },
  { id: "reaction", number: "05", name: "Reaction Test", kind: "arcade", playStyle: "timing", playCue: "Tap when the lights go out", description: "Wait for the lights, then tap as fast as you can." },
  { id: "word", number: "06", name: "Wordle", kind: "puzzle", playStyle: "puzzle", playCue: "Crack the five-letter word", description: "Six tries to find the hidden word, with clues for every letter." },
  { id: "flappy", number: "07", name: "Sky Flyer", kind: "arcade", playStyle: "action", playCue: "Tap through the gates", description: "Tap up through a changing sky without clipping the next gate." },
  { id: "platform", number: "08", name: "Mini Platformer", kind: "arcade", playStyle: "action", playCue: "Jump and grab every marker", description: "Jump across three short levels and collect every marker." },
  { id: "tic", number: "09", name: "Tic-Tac-Toe", kind: "board", playStyle: "board", playCue: "Make a line before the bot", description: "You are X. The computer is paying attention." },
  { id: "checkers", number: "10", name: "Checkers", kind: "board", playStyle: "board", playCue: "Set up a jump", description: "Choose a bot, make a jump, and see if you can take the board." },
  { id: "trade", number: "11", name: "City Trader", kind: "board", playStyle: "strategy", playCue: "Buy streets, then build", description: "Buy streets, build them up, and outlast the other players." },
  { id: "driftlock", number: "12", name: "Driftlock", kind: "arcade", playStyle: "action", playCue: "Flip gravity to reach the hatch", description: "Turn gravity, gather three signal cells, and reach the airlock." },
  { id: "2048", number: "13", name: "2048", kind: "puzzle", playStyle: "puzzle", playCue: "Slide equal tiles together", description: "Slide matching tiles together to make 2048." },
  { id: "dockside", number: "14", name: "Dockside", kind: "arcade", playStyle: "timing", playCue: "Drop the freight on center", description: "Time the crane. Stack freight as high as you can." },
  { id: "invaders", number: "15", name: "Invaders", kind: "arcade", playStyle: "action", playCue: "Shoot through each wave", description: "Keep the moon relay clear as the incoming waves come faster." },
  { id: "hex-stack", number: "16", name: "Hex Stack", kind: "puzzle", playStyle: "puzzle", playCue: "Turn the ring, match a spoke", description: "Turn the ring. Drop matching tiles before a spoke fills." },
  { id: "minesweeper", number: "17", name: "Minesweeper", kind: "puzzle", playStyle: "puzzle", playCue: "Read numbers, flag mines", description: "Read the numbers, mark the mines, and clear the board. A guess can cost the round if a safe square is certain." },
  { id: "block-drop", number: "18", name: "Block Drop", kind: "puzzle", playStyle: "puzzle", playCue: "Fit pieces, clear rows", description: "Place the falling pieces. Clear full rows before the stack reaches the top." },
  { id: "tidepool", number: "19", name: "Tidepool", kind: "arcade", playStyle: "action", playCue: "Shape the shore before high tide", description: "Shape a shore, plant kelp, and keep it wet through three tides." },
  { id: "chess", number: "20", name: "Chess", kind: "board", playStyle: "board", playCue: "Trade pieces for position", description: "Win a match to face a sharper opponent. How long can you stay at the table?" },
  { id: "handshake", number: "21", name: "Handshake", kind: "board", playStyle: "strategy", playCue: "Choose when to split a deal", description: "Four neighbors. Five deals each. Decide when to share and when to keep." },
  { id: "maze-chase", number: "22", name: "Maze Chase", kind: "arcade", playStyle: "action", playCue: "Clear lanes, then chase back", description: "Clear the lanes, read the corners, and turn on the pursuer with a power orb." },
  { id: "asteroids", number: "23", name: "Asteroids", kind: "arcade", playStyle: "action", playCue: "Turn, thrust, break the rocks", description: "Turn, thrust, and break up the rocks before your last ship is gone." },
  { id: "mahjong", number: "24", name: "Mahjong Solitaire", kind: "puzzle", playStyle: "puzzle", playCue: "Pair tiles with open edges", description: "Match open tiles and clear the layered garden." },
  { id: "klondike", number: "25", name: "Klondike", kind: "card", playStyle: "puzzle", playCue: "Uncover cards, build foundations", description: "Build the foundations, manage the stock, and uncover the tableau." },
  { id: "spookyball", number: "26", name: "Spookyball", kind: "arcade", playStyle: "timing", playCue: "Angle the paddle, clear the wall", description: "Angle the paddle, keep the ball alive, and clear the haunted wall." },
];

// Kept out of the collection, but still reachable for old bookmarks and saved runs.
const ARCHIVED_SHELF_GAMES = [
  { id: "clicker", number: "07", name: "Field Station", kind: "adventure", playStyle: "strategy", playCue: "Fund the next expedition", description: "Fund a research station, train assistants, and send out surveys." },
];
